...
import { logoPath, logoWhitePath } from '@/assets/icons';
...
const HeaderMedia: React.FC<HeaderMediaProps> = ({
    isOpenSearch = false,
    transparent = false,
    white = false,
    setIsOpenSearch,
    ...
    return (
        <header
            className={getClassNames('header-media', {
                ...
                'header-media--white': !isScrolled && white,
            })}
            ref={ModalRef}
        >
            <div className="container">
                <div className="header-media-wrapper">
                    <div className="header-media-icon-group">
                        <div className="header-media-icon menu" onClick={toggleState}>
                            {state ? (
                                <svg
                                    width="24"
                                    height="18"
                    ...
                    <Link href={APP_ROUTE.home} className="header-media-logo">
                        <BaseImage
                            src={!isScrolled && white ? logoWhitePath : logoPath}
                            alt="THECULTT logo"
