	...
	return (
		<div className="product-content-info-split-popup">
			...
			<p className="product-content-info-split-popup__description">
				Сплит делит оплату на&nbsp;части&nbsp;&mdash; платежи можно вносить постепенно. Это не&nbsp;кредит и&nbsp;не&nbsp;рассрочка, поэтому у&nbsp;него нет анкет, проверки кредитной истории и&nbsp;скрытых условий. А&nbsp;покупку вы&nbsp;получите после первого платежа&nbsp;&mdash; то&nbsp;есть сразу.
			</p>
			...
			<div className="product-content-info-split-popup-greater-split">
				<h3 className="product-content-info-split-popup-greater-split__title">
					Улучшенный сплит
				</h3>
				...
				<a href={EXTERNAL_LINKS.yandexSplit} target='__blank' className="product-content-info-split-popup-greater-split__link">
