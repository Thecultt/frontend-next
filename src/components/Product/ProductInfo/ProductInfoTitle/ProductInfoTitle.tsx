...
const ProductInfoTitle: React.FC<Props> = ({ product, setBoutiquePopupVisible, setPartnerPopupVisible }) => {
    ...
    const [isCartLocal, setIsCartLocal] = React.useState(cartItems[article] ? true : false);
    const [isFavoriteLocal, setIsFavoriteLocal] = React.useState(favoritesItems[id] ? true : false);
            ...
            <div className="product-content-info-title">
                ...
                <div className="product-content-info-title-btn">
                    {canBuy ? (
                        ...
                        <button
                            className={`product-content-info-title-btn__btn subscribe ${isMobile ? 'btn-light-green' : 'btn'}`}
