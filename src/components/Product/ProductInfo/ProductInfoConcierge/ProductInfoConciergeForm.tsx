...
const ProductInfoConciergeForm: React.FC<{} & InjectedFormProps<{}, {}>> = ({
    handleSubmit,
    initialize,
    invalid,
    submitting,
    ...
    return (
        <form className="product-content-info-concierge-form" onSubmit={handleSubmit}>
            {submitSucceeded ? (
                <div className="product-content-info-concierge-form-success">
                ...
                <>
                    <h3 className="product-content-info-concierge-form__title">Оставить заявку</h3>

                    <p className="product-content-info-concierge-form__description">
                        Заполните заявку, и&nbsp;мы&nbsp;свяжемся с&nbsp;вами в&nbsp;течение 24&nbsp;часов. Наш менеджер
                        ответит на&nbsp;любые вопросы о&nbsp;желаемом лоте, доставке, условиях и&nbsp;сроках, или
                        поможет с&nbsp;выбором
                    </p>

                    <div className="product-content-info-concierge-form-input">
                    ...
                    <div className="product-content-info-concierge-form-btn">
                        <button
                            className={getClassNames('btn product-content-info-concierge-form-btn__btn', {
                        ...
                        <a
                            ...
                            target="__blank"
                            className="product-content-info-concierge-form-btn__social"
                        >
...
export default reduxForm<{}, {}>({
    form: 'product-content-info-concierge-form',
    validate,
})(ProductInfoConciergeForm);
