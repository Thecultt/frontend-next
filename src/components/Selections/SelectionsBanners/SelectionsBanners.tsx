...
import { HomeNewProducts } from '@/components/';
            ...
            {influencerSelection &&
                (isMobile ? (
                    <Link
                        ...
                        className="selections-banners-influencer"
                    >
                        <svg
                        ...
                        <div className="selections-banners-influencer__content">
                            ...
                            <p className="selections-banners-influencer__description">
                                {influencerSelection.description}
                            </p>
                        ...
                        <div className="selections-banners-bestsellers__items">
                            {autumnBagsSelection && (
                                <Link
                                    ...
                                    className="selections-banners-bestsellers-item hover-scale"
                                >
                                    <div
