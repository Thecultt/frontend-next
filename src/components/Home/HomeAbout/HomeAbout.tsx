                ...
                >
                    <div className="home-about-text">
                        ...
                        <p className="home-about-text__description">
                            Обувь, сумки и аксессуары, отобранные кураторами с вниманием к селекции. Лоты THE CULTT —
                            предметы с историей, достойные стать частью вашей.
                        </p>
                    </div>
                </Link>
            ) : (
