...
const tabs: { title: string; description: string }[] = [
    ...
    },
    {
		...
		<br />
		<br />
		2. Приехать в нашу клиентскую зону, расположенную прямо в нашем офисе. Адрес: Россия, Москва, ${CONTACTS.address} Примерка в клиентской зоне доступна ежедневно с 10:00 до 19:00. Нужна предварительная запись. На примерку у вас будет 30 минут. К примерке доступны 5 товаров, если у вас уже есть конкретные лоты - пожалуйста, укажите ссылки на них в заявке. Это сэкономит ваше время. 
		<br />
		<br />
