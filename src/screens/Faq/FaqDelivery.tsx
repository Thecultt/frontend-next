                ...
                <div className="faq-text">
                    ...
                    <div className="faq-text-block">
                        ...
                        <div className="faq-text-block-description">
                            ...
                            <p>
                                Доступна для оплаченных на сайте заказов с доставкой по России. Заказы с доставкой по
                                России отправляются курьерской службой СДЭК до вашего адреса или пункта самовывоза (вы
                                можете указать адрес ПВЗ в комментариях к заказу). Средний срок доставки — 2–10 дней в
                            ...
                            <p>
                                Доступна для оплаченных на сайте заказов с доставкой по Москве. Доставка осуществляется
                                курьером THE CULTT, сроки доставки — 1–3 дня. Предварительно курьер свяжется и уточнит
                            ...
                            <ul>
                                ...
                                <li>
                                    если в заказе присутствуют несколько товарных категорий (сумки, обувь, аксессуары),
                                    то не более 4 товаров в одном заказе.
                                </li>
                            </ul>
                            ...
                            <p>
                                4. Если вам требуется больше времени (от 15 до 45 минут), то необходимо будет оплатить
                                двойную стоимость примерки (1.200₽).
                            </p>

                            <p>Доставка осуществляется только по Москве в пределах МКАД.</p>
                            <p>
                                Лоты будут забронированы для вас на 24 часа и отправлены на примерку курьером THE CULTT.
                                Принять решение о покупке вы можете уже после примерки.
                            </p>
                            ...
                            <p>
                                <b>
                                    Вы можете забрать заказ у в офисе THE CULTT с 10:00 до 21:00, без предварительной
                                    записи.
                                </b>
                            </p>
                            ...
                            <p>
                                ...
                                Просим учитывать это при планировании посещения офиса.
                            </p>

                            <h3>5. Бесплатная примерка в клиентской зоне THE CULTT</h3>

                            <p>
                                Вы можете записаться по ссылке на примерку в нашей клиентской зоне в Москве. Менеджер
                                свяжется с вами накануне и сообщит о наличии изделий.
                            </p>
                            ...
                            <p>
                                <strong>
                                    Внимание! Клиентская зона закрыта с 10.07. Это временно — мы обновляем пространство.
                                    Как только запись в клиентскую зону откроется снова, мы пришлем зарегистрированным
                                    пользователям уведомление.
                                </strong>
                            </p>
                            ...
                            <p>
                                Международная доставка по миру осуществляется службой EMS. Стоимость доставки по миру —
                                6.000₽.
                            </p>
                    ...
                    <div className="faq-text-block">
                        ...
                        <div className="faq-text-block-description">
                            ...
                            <p>
                                Вы можете оплатить заказ картами МИР, MasterCard (российский банк),, VISA (российский
                                банк), UnionPay, YandexPay на сайте при оформлении заказа.
                            </p>
                            ...
                            <p>
                                Заказ можно оплатить на сайте только с российской карты банка. На данный момент система
                                CloudPayments не принимает оплату с зарубежных карт, только российских и карт стран СНГ,
                                если платежная система МИР.
                            </p>
                            ...
                            <p>
                                Вы можете оплатить заказ с помощью беспроцентной рассрочки от банка Тинькофф или кредита
                                от банков МТС Банк, ОТП Банк Тинькофф Банк.
                            </p>
                            ...
                            <p>
                                При оплате услугой "Кредит" сумма кредита и срок зависит от выбора ваших условий и будет
                                известна после оформления.
                            </p>
                            ...
                            <p>
                                Сплит делит оплату на части, которые списываются в течение 2, 4 или 6 месяцев. Это не
                                кредит и не рассрочка, поэтому у него нет длинных анкет, проверки кредитной истории и
                                скрытых условий.
                            </p>
                            ...
                            <p>
                                3. Оплатите первую часть, и покупка сразу ваша. Остальные платежи спишутся позже — по
                                графику.
                            </p>
                            ...
                            <p>
                                Заказ, оплаченный в сплит, можно вернуть по стандартным условиям. А деньги, которые вы
                                уже заплатили, Яндекс Сплит отправит обратно на карту.
                            </p>
                        </div>
                    </div>
                </div>
