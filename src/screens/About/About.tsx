            ...
            <div className="about-wrapper">
                <div className="about-main hover-scale">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage: `url("${AboutMainImage.src}")`,
                        }}
                    />
                </div>
                <div className="about-cultt">
                    <div
                        ...
                        style={{
                            backgroundImage: `url("${AboutCulttImage.src}")`,
                        }}
                    />
                    <div className="about-cultt-text">
                        ...
                        <p className="description about-cultt-text__description">
                            Проект был запущен в октябре 2020 года четырьмя девушками: Аней Автайкиной, Дашей Зосименко,
                            Машей Манаевой, Таней Ермаковой. <br /> <br /> Он стал синергией нашего разнопланового опыта
                            в развитии диджитал продуктов, персональном стайлинге, развитии рекламной платформы и
                ...
                <div className="about-quote hover-scale">
                    ...
                    <div className="about-quote-description">
                        <p className="description about-quote-description__description">
                            ...
                            подлинность и состояние до публикации на платформе THE CULTT, а команда стилистов отбирает
                            лоты на соответствие актуальности моделей и брендов. Вам не придется пролистывать тысячу
                            товаров для того, чтобы найти один интересный вариант.
                        </p>

                        <p className="description about-quote-description__description">
                            Мы всей душой любим сумки и считаем их знаковым предметом гардероба, способным сделать любой
                            образ интересным и актуальным. Надеемся, что вы найдете сумку мечты именно у нас!
                        </p>
                    </div>
                </div>
                ...
                <div className="about-team">
                    ...
                    <p className="description about-team__description">
                        Познакомьтесь с основательнницами THE CULTT - Анна Автайкина, Дарья Зосименко, Мария Манаева и
                        Таня Ермакова. Они всегда любили ресейл и объединились, чтобы вместе формировать КУЛЬТуру нового
                        потребления.
                    </p>
                    ...
                    <div className="about-team-members">
                        ...
                        <div
                            className="about-team-members-item hover-scale"
                            style={{
                                backgroundImage: `url("${Tatiana.src}")`,
                            }}
                        >
